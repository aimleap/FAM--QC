...
const baseURLPrefix = 'https://wpde.com';
const baseURLSuffix = '/api/rest/audience/more?section=wpde.com/news/local&limit=0&offset=0';
...
export const parser = new LiteParser('ABC 15 News Myrtle Beach', baseURLPrefix, [
  {
    selector: ['*'],
