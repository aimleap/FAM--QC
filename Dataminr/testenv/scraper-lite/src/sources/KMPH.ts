...
const domainUrl = 'https://kmph.com/';
async function preThreadHandler(): Promise<Thread[]> {
  const preThreads: Thread[] = [];
  const link1 = 'https://kmph.com/api/rest/audience/more?section=kmph.com/news/local&limit=0&offset=0'; // Local News
  const link2 = 'https://kmph.com/api/rest/audience/more?section=kmph.com/news/nation-world&limit=0&offset=0'; // Nation-world
  const link3 = 'https://kmph.com/api/rest/audience/more?section=kmph.com/sports/content&limit=0&offset=0'; // Sports
  const link4 = 'https://kmph.com/api/rest/audience/more?section=kmph.com/news/entertainment&limit=0&offset=0'; // Entertainment
  const link5 = 'https://kmph.com/api/rest/audience/more?section=kmph.com/news/crime&limit=0&offset=0'; // Crime
...
export const parser = new LiteParser('KMPH', domainUrl, [
  {
    selector: ['*'],
