...
const baseURL = 'https://foxsanantonio.com/api/rest/audience/more?section=foxsanantonio.com/news/local&limit=50';
...
export const parser = new LiteParser('KABB', baseURL, [
  {
    selector: ['*'],
