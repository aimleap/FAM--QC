...
const baseURLSuffix = '/5461/nieuws?page=0';
moment.locale('nl');
...
async function postHandler(
  ...
  const articleInfo = `${title}; ${date}; ${description}`;
  const extraDataInfo = {
    title,
    date,
    description,
...
export const parser = new LiteParser('Dutch National Police West Coast News', baseURLPrefix, [
  {
