...
async function postHandler(
  ...
  if (url === 'https://uk.usembassy.gov/u-s-citizen-services/security-and-travel-information/') {
    return posts;
  }
  ...
  const domainUrl = 'https://uk.usembassy.gov/';
...
export const parser = new LiteParser(
  'US Embassy UK Alerts',
  'https://uk.usembassy.gov/u-s-citizen-services/security-and-travel-information/',
  [
    {
