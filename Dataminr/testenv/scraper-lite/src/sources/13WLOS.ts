...
const baseURLPrefix = 'https://wlos.com';
const baseURLSuffix = '/api/rest/audience/more?section=wlos.com/news/local&limit=48&offset=0';
...
export const parser = new LiteParser('13 WLOS', baseURLPrefix, [
  {
    selector: ['*'],
