...
const baseURLPrefix = 'https://wset.com';
const baseURLSuffix = '/api/rest/audience/more?section=wset.com/news/local&limit=0&offset=0';
...
async function postHandler(
  ...
  const articleInfo = `virginia: ${title} ; ${subTitle}`;
  const extraDataInfo = {
...
export const parser = new LiteParser('WSET', baseURLPrefix, [
  {
    selector: ['*'],
