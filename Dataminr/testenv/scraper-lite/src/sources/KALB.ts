...
const baseURLPrefix = 'https://www.kalb.com';
...
async function postHandler(
  ...
  const articleInfo = `louisiana: ${title}; ${subTitle}`;
  const extraDataInfo = {
    title,
    subTitle,
    articleFullText,
...
export const parser = new LiteParser(
  ...
  [
    {
      selector: [
        '.top-featured .card-deck .card , .middle-featured .card-deck .card , .middle-top .card-deck .card',
      ],
