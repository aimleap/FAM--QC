...
async function postHandler(
  ...
  if (url === 'https://au.usembassy.gov/u-s-citizen-services/security-and-travel-information/') {
    return posts;
  }
  ...
  const domainUrl = 'https://au.usembassy.gov/';
...
export const parser = new LiteParser(
  'US Embassy AU Alerts',
  'https://au.usembassy.gov/u-s-citizen-services/security-and-travel-information/',
  [
    {
