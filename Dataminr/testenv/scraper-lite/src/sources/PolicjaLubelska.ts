...
const baseURLPrefix = 'https://lubelska.policja.gov.pl';
const baseURLSuffix = '/lub/aktualnosci';
...
async function postHandler(
  ...
  const articleInfo = `lubelska: ${title}; ${description}; ${dodanoText}`;
  const extraDataInfo = {
    title,
    description,
    dodano: dodanoText,
...
export const parser = new LiteParser('Policja Lubelska', baseURLPrefix, [
  {
    selector: ['*'],
