...
async function postHandler(
  ...
  elements.forEach((el) => {
    ...
    posts.push(
      new Post({
        text: `Device: ${deviceName}; Applicant: ${applicant}; PMA Number: ${number}; Decision Date: ${decisionDate}`,
        postUrl: url,
...
export const parser = new LiteParser(
  ...
  'https://www.accessdata.fda.gov/scripts/cdrh/cfdocs/cfPMA/pma.cfm?start_search=1&applicant=&tradename=&productcode=&pmanumber=&supplementnumber=&advisorycommittee=&docketnumber=&supplementtype=&expeditedreview=&center=&ivdproducts=off&combinationproducts=off&decisiondatefrom=&decisiondateto=11%2F24%2F2021&noticedatefrom=&noticedateto=&znumber=&pagenum=25',
  [
    {
