...
const baseURLPrefix = 'https://13wham.com';
const baseURLSuffix = '/api/rest/audience/more?section=13wham.com/news/local&limit=48&offset=0';
...
export const parser = new LiteParser('WHAM', baseURLPrefix, [
  {
    selector: ['*'],
