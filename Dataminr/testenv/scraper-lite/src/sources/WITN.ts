...
const baseURLPrefix = 'https://www.witn.com';
...
async function postHandler(
  ...
  const date = moment(dateText, ['minutes ago', 'hours ago', 'MMM DD, YYYY at hh:mm a EDT']).format('MMM DD, YYYY hh:mm a');
...
export const parser = new LiteParser('WITN', baseURLPrefix, [
  {
