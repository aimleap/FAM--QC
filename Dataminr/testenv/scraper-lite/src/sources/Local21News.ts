...
const baseURLPrefix = 'https://local21news.com';
const baseURLSuffix = '/api/rest/audience/more?section=local21news.com/news/local&limit=0&offset=0';
...
async function postHandler(
  ...
  const subTitle = jsonObject.summary;
  ...
  const articleInfo = `pennsylvania: ${title} ; ${subTitle}`;
  const extraDataInfo = {
...
export const parser = new LiteParser('Local 21 News', baseURLPrefix, [
  {
    selector: ['*'],
